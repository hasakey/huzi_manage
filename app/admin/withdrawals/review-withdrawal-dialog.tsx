...
export default function ReviewWithdrawalDialog({
  transaction,
  open,
  onOpenChange,
  onReviewComplete,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>请仔细核对提现信息后做出决定</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          {/* 提现信息 */}
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-gray-700">提现信息</h4>
            <div className="rounded-lg bg-gray-50 p-3 space-y-1">
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">提现金额：</span>
